...
If Python is installed on your machine, type `pip install shapelets` into your terminal/command line to install the shapelets library.
Otherwise, see below for specific instructions on installing Python.
